...
# ℹ️ 상단 설명 문구
st.markdown("""
> 🕊️ **독립운동가의 업적을 더 잘 기억하기 위해서 어떻게 하면 좋을지 고민하던 중 자신의 생일이 독립운동가의 서거일, 역사적 사건 등과 연결되면 더 쉽게 기억할 수 있고 의미있는 기억이 될수 있을것 같아서 이 앱을 제작하게 되었습니다.**
""")


# 🔽 독립운동가 데이터
people_data = {
    "이름": ["안중근", "윤봉길", "이봉창", "김상옥", "유관순", "김구", "안창호", "방정환", "여운형", "권기옥", "남자현", "신채호", "양기탁","김광제"],
    "서거연도": ["1910년", "1932년", "1932년", "1923년", "1920년", "1949년", "1938년", "1931년", "1947년", "1988년", "1933년", "1936년", "1938년","1920년"],
    "서거일": ["3월 26일", "12월 19일", "10월 10일", "1월 22일", "9월 28일", "6월 26일", "3월 10일", "7월 23일", "7월 19일", "4월 19일", "8월 22일", "2월 21일", "4월 19일","7월 24일"],
    "주요업적": ["이토히로부미 저격", "", "", "", "", "", "", "어린이날 창시자", "", "한국 최초 여성 파일럿", "", "", "","국채보상운동을 이끌었음."]
}
...
# 🔽 독립운동 사건 데이터
event_data = {
    "독립운동이름": ["3.1 운동", "광주학생운동", "봉오동 전투", "청산리 대첩", "한인애국단 창단", "도쿄 사쿠라다몬 의거"],
    "발생날짜": ["3월 1일", "11월 3일", "6월 7일", "10월 21일", "12월 10일", "1월 8일"],
    "간단설명": [
        ...
        "1932년 이봉창 의사가 히로히토 일본 천황을 암살하기위해 벌인 의거"
    ]
}
